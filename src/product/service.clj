...
;; Tabular routes
;; GET  /products/:id/?flds=name,description,price,rating  - get product details
;; PUT  /products/:id                                      - create new product with specified id
;; POST /products                                          - create a new product and return id
;; PUT  /products/:id/rating                               - Add rating for a product
...
;; Consumed by product.server/create-server
